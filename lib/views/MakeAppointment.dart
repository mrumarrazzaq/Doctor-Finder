...
import 'package:appcode3/PaymentGateways/MyBrainTreeUtils.dart';
...
class _MakeAppointmentState extends State<MakeAppointment> {
  ...
  initialize() {
    ...
    SharedPreferences.getInstance().then((pref) {
      setState(() {
        ...
        doctorId = widget.id;
        checkHolidayFuture = checkIfHoliday(date,true,i: 0,);
      });
    });
  }
    ...
    return InkWell(
      onTap: () {
        setState(() {
          ...
          checkHolidayFuture = checkIfHoliday(date,false,i: i,);
          print(date);
  ...
  Future<bool> checkIfHoliday(String date, bool isFirst,{required int i}) async {
